...
DynamicText text1 ("../Assets/font.ttf", 32);
DynamicText text2 ("../Assets/font.ttf", 50);
...
void HandleRendering()
{
    ...
    text1.DrawText(app->GetRender(),"Mike SDL2",10,10,100,50);


    static int counter = 0 ;
    counter++;
    text2.DrawText(app->GetRender(),std::to_string(counter),100,100,30,40);
