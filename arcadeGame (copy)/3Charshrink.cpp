...
int main()
{
    ...
    while (gameIsRunning)
    {
        ...
        if (isJumping)
        {
            ...
            // if(Right_Playerrect.y <= peakHeig)
        }
        else
        {
            // Right_Playerrect.y += fallSpeed;
            if (Right_Playerrect.y >= groundLevel)
            {
                Right_Playerrect.y = groundLevel;
                isJumping = false;
        ...
        SDL_Rect scaledRect = {Right_Playerrect.x, Right_Playerrect.y,
                               static_cast<int>(Right_Playerrect.w * scaleFactor),
                               static_cast<int>(Right_Playerrect.h * scaleFactor)};
        ...
        SDL_RenderCopyEx(render, Right_person, NULL, &scaledRect, rotationAngle, NULL, flip);
